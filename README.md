...
Never commit credentials. Use `.env` (it's gitignored). The `linkedin_cookies.json` file is also gitignored. LinkedIn does not officially support third-party API access.
